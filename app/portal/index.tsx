...
export default function PortalWebView() {
  ...
  }, [session?.username, session?.password, session?.database, workspaceUrl]);
      ...
      {!autoLoginSource ? (
        ...
        <View className="flex-1">
          ...
          <WebView
            ...
            onLoadEnd={({ nativeEvent }) => handleNavigation({ url: nativeEvent.url })}
